    ...
    public class LineGrapherInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            foreach (LineGrapher.GraphConfig graphConfig in ((LineGrapher)target).graphConfigs)
            {
                ...
                GUI.Label(new Rect(labelPosX, windowRectangle.y, 50, 50), "max =  " + graphConfig.VerticalAxisYmax.ToString(), style);
                GUI.Label(new Rect(labelPosX, windowRectangle.y + windowRectangle.height - 13, 50, 50), "min = " + graphConfig.VerticalAxisYmin.ToString(), style);
